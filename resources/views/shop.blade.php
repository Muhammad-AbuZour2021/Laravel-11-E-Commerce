...
{{--
                            ...
                            <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                           ...
                                           {{ $slide->tagline }} <br /><strong> {{ $slide->title }}</strong></h2>
                                ...
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="{{ asset('uploads/slides') }}/{{ $slide->image }}" width="630"
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="Sort items" name="order" id="order">
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            aria-label="page Size" name="page-size" id="page-size" style="margin-right:20px;">
                                ...
                                <div class="pc__img-wrapper">
                                    ...
                                    @if (Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                                        <a href="{{ route('cart.index') }}"
                                            class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn btn-warning mb-3">View
                                            in Cart</a>
                                    @else
        ...
        <form id="frmfilter" action="{{ route('shop.index') }}" method="GET">
            <input type="hidden" name="size" id="pagesize" value="{{ $size }}">
            <input type="hidden" name="page" id="current-page" value="{{ $products->currentPage() }}">
            <input type="hidden" name="order" id="order-val" value="{{ $order }}">
            <input type="hidden" name="brands" id="brands-val" value="">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.chk-brand').on('change', function() {
                ...
                $('#brands-val').val(selectedBrands.join(','));
                $('#current-page').val(1);
                $('#frmfilter').submit();
            });
            ...
            $('.chk-category').on('change', function() {
                ...
                $('#categories-val').val(selectedCategories.join(','));
                $('#current-page').val(1);
                $('#frmfilter').submit();
            });
            ...
            if (slider.length) {
                ...
                // تحديث القيم أثناء التحريك (عرض فقط)
                ...
                // عند إفلات السلايدر (تنفيذ الفلتر)
