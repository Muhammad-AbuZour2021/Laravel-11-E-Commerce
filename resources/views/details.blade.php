                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gimg)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/gallery') }}/{{ $gimg }}"
                                                width="674" height="674" alt="" />
                                            <a data-fancybox="gallery"
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gimg)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products/gallery/' . $gimg) }}" width="104"
                                                height="104" alt="" />
                                        </div>
                                    @endforeach
                            ...
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    ...
                                    <a href="{{ route('shop.product.details', $rProduct->slug) }}"
                                        ...
                                        <!-- صورة hover (أول صورة فقط) -->
                                        @php
                                            $images = explode(',', $rProduct->images);
                                        @endphp

                                        @if (!empty($images[0]))
                                            <img loading="lazy" src="{{ asset('uploads/products/gallery/' . $images[0]) }}"
                                                width="330" height="400" class="pc__img pc__img-second">
                                        @endif
