...
@section('content')
                        ...
                        <div class="main-content-inner">
                            ...
                            <div class="main-content-wrap">
                                ...
                                <!-- new-category -->
                                <div class="wg-box">
<form class="form-new-product form-style-1" action="{{route('admin.slides.store')}}" method="POST" enctype="multipart/form-data">                                        @csrf
                                        <fieldset class="name">
                                        ...
                                        <fieldset class="category">
                                            ...
                                            <div class="select flex-grow">
                                                <select name="status" class="">
                                                    ...
                                                    <option value="0" @if (old('status')== "0") selected @endif>Inacive</option>
                                                </select>
                                            </div>
                                        </fieldset>
                                        <div class="bot">
