    ...
    <div class="main-content-inner">
        ...
        @if ($errors->any())
            <div class="alert alert-danger"
                style="color: red; background: #fee; padding: 10px; margin-bottom: 20px; border-radius: 5px;">
                <ul>
        ...
        <div class="main-content-wrap">
            ...
            <!-- form-add-product -->
            <form class="tf-section-2 form-add-product" method="POST" action="{{ route('admin.product.store') }}"
                            ...
                            <div class="select">
                                <select class="" name="brand_id">
                                    ...
                                    @foreach ($brands as $brand)
                                        {{-- تم تغيير $brands الثانية لـ $brand (مفرد) لتجنب الأخطاء --}}
