                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt=""  src="{{ asset('uploads/W2.png') }}"
                                data-light="{{ asset('uploads/W2.png') }}" data-dark="{{ asset('uploads/W2.png') }}">
                        </a>
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.categorys.add')}}" class="">
                                                <div class="text">New Category</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{route('admin.categorys')}}" class="">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{ asset('uploads/web.jpeg') }}"
                                        data-light="{{ asset('uploads/web.jpeg') }}" data-dark="{{ asset('uploads/web.jpeg') }}"
                                        data-width="154px" data-height="52px" data-retina="{{ asset('uploads/web.jpeg') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
